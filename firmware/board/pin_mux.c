...
- {pin_num: A12, pin_signal: PIO0_9/FC0_P5/CT_INP1/FLEXIO0_D1/ADC0_B9, label: 'P0_9/J8[10]', identifier: LCD_DC}
- {pin_num: B12, pin_signal: PIO0_10/FC0_P6/CT0_MAT0/FLEXIO0_D2/ADC0_B10, label: 'P0_10/SJ5[1]', identifier: LED_RED}
- {pin_num: C12, pin_signal: PIO0_8/FC0_P4/CT_INP0/FLEXIO0_D0/ADC0_B8, label: 'P0_8/J8[11]', identifier: LCD_RST}
...
- options: {callFromInitBoot: 'true', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: F6, peripheral: LP_FLEXCOMM5, signal: LPFLEXCOMM_P0, pin_signal: PIO1_16/WUU0_IN14/FC5_P0/FC3_P4/CT_INP12/SCT0_OUT6/FLEXIO0_D24/SMARTDMA_PIO12/PLU_OUT4/ENET0_RXD2/I3C1_SDA/ADC1_A16}
  - {pin_num: F4, peripheral: LP_FLEXCOMM5, signal: LPFLEXCOMM_P1, pin_signal: PIO1_17/FC5_P1/FC3_P5/CT_INP13/SCT0_OUT7/FLEXIO0_D25/SMARTDMA_PIO13/PLU_OUT5/ENET0_RXD3/I3C1_SCL/ADC1_A17}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitMWMPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitMWMPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITMWMPINS_RST_GPIO, BOARD_INITMWMPINS_RST_PIN, &RST_config);
    ...
    PORT_SetPinMux(BOARD_INITMWMPINS_RST_PORT, BOARD_INITMWMPINS_RST_PIN, kPORT_MuxAlt0);
...
- pin_list:
  ...
  - {pin_num: C13, peripheral: LP_FLEXCOMM0, signal: LPFLEXCOMM_P3, pin_signal: PIO0_7/WUU0_IN1/FC0_P3/CT_INP3/CMP2_IN1}
  - {pin_num: A12, peripheral: GPIO0, signal: 'GPIO, 9', pin_signal: PIO0_9/FC0_P5/CT_INP1/FLEXIO0_D1/ADC0_B9, direction: OUTPUT}
...
void BOARD_InitLCDPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITLCDPINS_LCD_DC_GPIO, BOARD_INITLCDPINS_LCD_DC_PIN, &LCD_DC_config);
    ...
    /* PORT0_7 (pin C13) is configured as FC0_P3 */
    PORT_SetPinMux(PORT0, 7U, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITLCDPINS_LCD_DC_PORT, BOARD_INITLCDPINS_LCD_DC_PIN, kPORT_MuxAlt0);
