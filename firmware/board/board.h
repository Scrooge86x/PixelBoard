...
/* Serial MWM WIFI */
#define BOARD_SERIAL_MWM_PORT_CLK_FREQ CLOCK_GetLPFlexCommClkFreq(5)
#define BOARD_SERIAL_MWM_PORT          LPUART5
#define BOARD_SERIAL_MWM_PORT_IRQn     LP_FLEXCOMM5_IRQn
#define BOARD_SERIAL_MWM_RST_WRITE(output) GPIO_PinWrite(BOARD_INITMWMPINS_RST_GPIO, BOARD_INITMWMPINS_RST_GPIO_PIN, output)
