...
- {id: CLK_144M_clock.outFreq, value: 144 MHz}
- {id: CLK_48M_clock.outFreq, value: 48 MHz}
- {id: FLEXCOMM0_clock.outFreq, value: 50 MHz}
...
- {id: SYSCON.FCCLKSEL0.sel, value: SYSCON.PLL_DIV_CLK}
- {id: SYSCON.FCCLKSEL5.sel, value: SCG.FRO_12M}
- {id: SYSCON.FLEXCOMM0CLKDIV.scale, value: '3', locked: true}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_AttachClk(kPLL_DIV_to_FLEXCOMM0);                 /*!< Switch FLEXCOMM0 to PLL_DIV */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom0Clk, 3U);           /*!< Set FLEXCOMM0CLKDIV divider to value 3 */
