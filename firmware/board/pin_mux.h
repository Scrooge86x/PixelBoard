...
/* Symbols to be used with GPIO driver */
#define BOARD_INITMWMPINS_RST_GPIO GPIO1               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITMWMPINS_RST_INIT_GPIO_VALUE 0U       /*!<@brief GPIO output initial state */
#define BOARD_INITMWMPINS_RST_GPIO_PIN 3U              /*!<@brief GPIO pin number */
#define BOARD_INITMWMPINS_RST_GPIO_PIN_MASK (1U << 3U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITMWMPINS_RST_PORT PORT1               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMWMPINS_RST_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_INITMWMPINS_RST_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                       /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITLCDPINS_LCD_DC_GPIO GPIO0               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITLCDPINS_LCD_DC_INIT_GPIO_VALUE 0U       /*!<@brief GPIO output initial state */
#define BOARD_INITLCDPINS_LCD_DC_GPIO_PIN 9U              /*!<@brief GPIO pin number */
#define BOARD_INITLCDPINS_LCD_DC_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITLCDPINS_LCD_DC_PORT PORT0               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITLCDPINS_LCD_DC_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INITLCDPINS_LCD_DC_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITLCDPINS_LCD_RST_GPIO GPIO0               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITLCDPINS_LCD_RST_INIT_GPIO_VALUE 1U       /*!<@brief GPIO output initial state */
#define BOARD_INITLCDPINS_LCD_RST_GPIO_PIN 8U              /*!<@brief GPIO pin number */
#define BOARD_INITLCDPINS_LCD_RST_GPIO_PIN_MASK (1U << 8U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITLCDPINS_LCD_RST_PORT PORT0               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITLCDPINS_LCD_RST_PIN 8U                   /*!<@brief PORT pin number */
#define BOARD_INITLCDPINS_LCD_RST_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                                           /* @} */
